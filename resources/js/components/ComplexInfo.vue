                    ...
                    <div class="new-object">
                        ...
                        <div class="new-object-body">
                            ...
                            <div class="form-item-half d-flex-justify">
                                ...
                                <label class="f-item" for="purtable"> ДА
                                    <input type="checkbox" name="is_purtable" id="purtable" v-model="court.is_purtable">
                                </label>
                                <label class="f-item">
                                    <input type="number" name="part_count" v-model="court.part_count">
                                </label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="new-object-body">
                            ...
                            <div class="form-item-half d-flex-justify">
                                ...
                                <div class="sidebar-item">
                                    <label class="select-label select">
                                        <select v-model="court.c_coverage_id">
                                            <option v-for="item in type_coverages" :value="item.tc_id">{{ item.tc_name
                                                }}
                                            </option>
                                        </select>
                                        <i class="fas fa-chevron-down arrow-select"></i>
                            ...
                            <div class="form-item-half">
                                <div class="btn-box">
                                    <button class="btn-plain btn-blue" @click.prevent="editForm(court)">Разместить
                                    </button>
                                </div>
                            </div>
                        </div>
