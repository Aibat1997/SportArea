        ...
        <form>
            <div class="form-item-half d-flex-justify-start">
                <div class="edit-cover">
                    <a href="#tab-4" data-toggle="tab" class="btn-plain add-call invent-add" @click="clearInventory">
                ...
                <label class="date-label" v-if="inventories">
                    <div class="new-invent" v-for="inventory in inventories">
                        <div class="checkbox-cover d-flex-justify">
                            <input type="checkbox" class="ios8-switch checkbox-attr" :id="inventory.inv_id" v-model="inventory.inv_is_active" @change="activateInventory(inventory)"/>
        ...
        <div class="question-popup add-invent-modal">
            ...
            <form>
                ...
                <div class="inventar-label d-flex">
                    <input type="text" placeholder="Название" v-model="inventory.inv_name" class="input-attr invent-text"/>
            ...
            <form>
                ...
                <div class="inventar-label d-flex">
                    <div class="checkbox-cover">
                        <input type="checkbox" class="ios8-switch checkbox-attr" v-model="inventory.inv_is_active" id="checkbox-106"/>
                        <label for="checkbox-106"></label>
                        <input type="text" placeholder="Инвентар" v-model="inventory.inv_name" class="input-attr"/>
                    </div>
                    <label class="price-current">
